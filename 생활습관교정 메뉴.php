		...
		<?php } ?>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1>생활습관교정🧘‍♂</h1>
							<p></p><b>좋은 생활습관</b>을 만들고 싶은데 마음대로 되지 않으시나요? 일상의 생활습관은 의도하지 않고는 고쳐지지 않아 어렵기 때문에 <b>의식적으로 실천해야해요</b>. 
								알람을 통해 <b>자신을 위한 좋은 생활습관을 만들어보세요</b>.</p>
							<section>
								<h3>MENU</h3>
								<ul class="actions fit">
									<li><a href="타이머2.php" class="button primary fit">알람설정</a></li>
								</ul>
					</section>
				</div>
			</div>
