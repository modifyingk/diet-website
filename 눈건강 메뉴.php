...
<?php } ?>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1>눈 건강 👁</h1>
							<p><b>눈 건강</b>에는 이상이 없는데, 눈이 쉽게 <b>피곤</b>해지시나요? 그렇다면 <b>평소 생활환경과 습관을 점검해보세요</b>.
								일상의 생활환경과 습관은 단기적으로는 크게 영향이 없다 해도, 장기적으로는 누적되어 치명적인 영향을 줄 수 있습니다.
								특히 습관은 의도하지 않고는 고쳐지지 않아 어렵기 때문에 더욱 의식적으로 실천해야합니다.
								알람을 통해 <b>눈 건강을 위한 좋은 생활습관을 만들어보세요</b>.</p>
							<section>
								<h3>MENU</h3>
								<ul class="actions fit">
									<li><a href="타이머.php" class="button primary fit">알람설정(1st)</a></li>
									<li><a href="타이머.php" class="button primary fit">알람설정(2nd)</a></li>
									<li><a href="타이머.php" class="button primary fit">알람설정(3rd)</a></li>
								</ul>
					</section>
				</div>
			</div>
