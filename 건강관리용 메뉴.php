						...
						<section>
							...
							<div class="box alt">
								<div class="row gtr-uniform">
								 <div class="col-4"><span class="image fit"><img src="건강관리1.png" alt="" /></span></div>
								<div class="col-4"><span class="image fit"><img src="스트레칭.png" alt="" /></span></div>
								<div class="col-4"><span class="image fit"><img src="요가.png" alt="" /></span></div>
								</div>
								</div>
							<ul class="actions fit">
								<li><a href="https://youtu.be/YOAM2kSHCHA" class="button primary fit">관절관리 영상</a></li>
								<li><a href="https://youtu.be/ECu-P8IqgHU" class="button primary fit">스트레칭 영상</a></li>
								<li><a href="https://youtu.be/AHasgA4OvXQ" class="button primary fit">요가 영상</a></li>
							</ul>
							<div class="col-6 col-12-medium">
                              ...
                              <tr>       
                                 <td>           
                              <input type=text name=q size=25 maxlength=255 placeholder="더&nbsp;많은 &nbsp;영상을&nbsp;시청하길 &nbsp;원한다면&nbsp;Youtube를 &nbsp;이용해보세요" /> <!-- 유튜브 검색 입력 창 -->  
                              <h3></h3>         
